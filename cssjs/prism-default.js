/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+csharp+ruby+go+groovy+java+json+perl+php+python&plugins=line-numbers+toolbar+copy-to-clipboard */
                    ...
                    for (var c = 0; c < g.length; ++c) {
                        ...
                        for (var b = r, k = i; b < t.length; k += t[b].length, ++b) {
                            ...
                            if (!(w instanceof s)) {
                                ...
                                if (_) {
                                    d && (p = _[1].length);
                                    var A = _.index + p, _ = _[0].slice(p), j = A + _.length, N = w.slice(0, A),
                                        C = w.slice(j), E = [b, P];
                                    N && (++b, k += N.length, E.push(N));
                                    var L = new s(u, f ? n.tokenize(_, f) : _, y, _, m);
                                    if (E.push(L), C && E.push(C), Array.prototype.splice.apply(t, E), 1 != P && n.matchGrammar(e, t, a, b, k, !0, u), l) break
                                } else if (l) break
                            }
                        }
                    }
...
Prism.languages.csharp = Prism.languages.extend("clike", {
    ...
    string: [{pattern: /@("|')(\1\1|\\\1|\\?(?!\1)[\s\S])*\1/, greedy: !0}, {pattern: /("|')(\\?.)*?\1/, greedy: !0}],
...
!function (e) {
    ...
    e.languages.insertBefore("ruby", "keyword", {
        regex: [{
            ...
            lookbehind: !0,
            greedy: !0
        }], variable: /[@$]+[a-zA-Z_][a-zA-Z_0-9]*(?:[?!]|\b)/, symbol: /:[a-zA-Z_][a-zA-Z_0-9]*(?:[?!]|\b)/
...
Prism.languages.groovy = Prism.languages.extend("clike", {
    ...
    string: [{pattern: /("""|''')[\s\S]*?\1|(\$\/)(\$\/\$|[\s\S])*?\/\$/, greedy: !0}, {
        pattern: /("|'|\/)(?:\\?.)*?\1/,
        greedy: !0
    }],
